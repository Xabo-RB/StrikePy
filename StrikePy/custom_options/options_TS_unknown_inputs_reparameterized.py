...
modelname = 'TS_unknown_inputs_reparameterized'
##############################################################################
...
nnzDerU = [1,1] # Number of non-zero known input derivatives in each experiment (Rows=inputs;Columns=experiments)
nnzDerW    = [1,1] # numbers of nonzero derivatives of the unmeasured inputs (w); may be 'inf'
###############################################################################
